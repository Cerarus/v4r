...
#      - V4R_VERSION                  : The version of this V4R build: "1.0.0"
#      - V4R_VERSION_MAJOR            : Major version part of V4R_VERSION: "1"
#      - V4R_VERSION_MINOR            : Minor version part of V4R_VERSION: "0"
#      - V4R_VERSION_PATCH            : Patch version part of V4R_VERSION: "0"
#      - V4R_VERSION_STATUS           : Development status of this build: "-dev"
#
#    Advanced variables:
...
set(V4R_INCLUDE_DIRS "${V4R_INSTALL_PATH}/share/V4R/3rdparty/include;${V4R_INSTALL_PATH}/include")
...
set(V4R_3RDPARTY_LIB_DIR_OPT "${V4R_INSTALL_PATH}/share/V4R/3rdparty/lib" CACHE PATH "Path where release 3rdparty V4R dependencies are located")
set(V4R_3RDPARTY_LIB_DIR_DBG "${V4R_INSTALL_PATH}/share/V4R/3rdparty/lib" CACHE PATH "Path where debug 3rdparty V4R dependencies are located")
...
SET(V4R_VERSION_MAJOR  1)
SET(V4R_VERSION_MINOR  0)
SET(V4R_VERSION_PATCH  0)
SET(V4R_VERSION_STATUS "-dev")
...
foreach(__opttype OPT DBG)
  ...
  if(V4R_CUDA_VERSION)
    ...
    if(V4R_USE_CUFFT)
      list(APPEND V4R_CUDA_LIBS_ABSPATH ${CUDA_CUFFT_LIBRARIES})
    endif()

    if(V4R_USE_NVCUVID)
      list(APPEND V4R_CUDA_LIBS_ABSPATH ${CUDA_nvcuvid_LIBRARIES})
    endif()
